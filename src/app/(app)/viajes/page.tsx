  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-5 sm:px-6 sm:py-6 lg:p-8">
      ...
      <section className="mx-auto max-w-7xl">
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex w-full flex-col gap-3 sm:flex-row lg:w-auto">
            <input
              ...
              className="min-h-11 w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-base sm:text-sm text-slate-900 outline-none transition focus:border-emerald-700 focus:ring-2 focus:ring-emerald-100 sm:w-96"
            />
        ...
        {(message || error) && (
          <div className="mb-4 rounded-2xl border border-slate-200 bg-white px-4 py-3 sm:mb-6 sm:px-5 sm:py-4 text-sm font-medium text-slate-700 shadow-sm">
            {message ||
